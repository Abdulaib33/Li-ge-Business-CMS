        ...
        <div>
            ...
            @if($settings['logo_path'])
                <div class="mt-3">
                    ...
                    <img class="mt-2 max-w-xs border" src="{{ asset('storage/settings/'.$settings['logo_path']) }}" alt="Logo">
                </div>
            @endif
        </div>
